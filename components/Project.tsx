...
const Project = ({title, description, tags, imageUrl}: ProjectProps  ) => {
  ...
  return (
    ...
    >
      <article className='bg-gray-100 max-w-[42rem] sm:h-[20rem] border border-blac/5 overflow-hidden sm:pr-8 relative group-even:pl-5
         hover:bg-gray-200 transition rounded-2xl'
      >
